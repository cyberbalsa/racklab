...
use App\Http\Controllers\Api\DocIndexController;
use App\Http\Controllers\Api\DocPublishController;
use App\Http\Controllers\Api\DocShowController;
use App\Http\Controllers\Api\DocStoreController;
use App\Http\Controllers\Api\DocUpdateController;
use App\Http\Controllers\Api\DocVersionIndexController;
...
Route::prefix('v1')
    ...
    ->group(function (): void {
        ...
        Route::get('/docs', DocIndexController::class)->name('api.v1.docs.index');
        Route::post('/docs', DocStoreController::class)->name('api.v1.docs.store');
        Route::get('/docs/{doc}', DocShowController::class)->name('api.v1.docs.show');
        Route::patch('/docs/{doc}', DocUpdateController::class)->name('api.v1.docs.update');
        Route::post('/docs/{doc}/publish', DocPublishController::class)->name('api.v1.docs.publish');
        Route::get('/docs/{doc}/versions', DocVersionIndexController::class)->name('api.v1.docs.versions.index');
