...
return [
    ...
    'description' => 'Public API for RackLab automation and integrations.',

    // Text to place in the "Introduction" section, right after the `description`. Markdown and HTML are supported.
    'intro_text' => <<<'INTRO'
            RackLab exposes the same tenant, RBAC, token, deployment, script, artifact, and provisioning controls used by the web UI.
        INTRO,
    ...
    'auth' => [
        ...
        'placeholder' => 'Token {YOUR_TRACK_B_TOKEN}',

        // Any extra authentication-related info for your users. Markdown and HTML are supported.
        'extra_info' => 'Use `Token <opaque PAT>` for Track-B tokens, or `Bearer <jwt>` for Track-A delegated JWTs.',
    ],
    ...
    'openapi' => [
        ...
        'generators' => [
            RackLabResponseDefaultsGenerator::class,
        ],
    ],
